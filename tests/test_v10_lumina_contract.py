...
class LuminaContractTests(unittest.TestCase):
    ...
    def test_active_plan_and_preview_are_current(self) -> None:
        ...
        self.assertIn(manifest["release"]["stableVersion"], ("11.0.0", "12.0.0", "12.0.1", "13.0.0", "13.0.1", "13.0.2"))
        self.assertIn((ROOT / "VERSION").read_text(encoding="utf-8").strip(), ("11.0.0", "12.0.0", "12.0.1", "13.0.0", "13.0.1", "13.0.2"))
