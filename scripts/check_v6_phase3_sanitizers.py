    ...
    with tempfile.TemporaryDirectory(prefix="noxforge-v6-phase3-sanitizers-") as temporary:
        ...
        subprocess.run(
            [
                ...
                "--output-on-failure",
                "-R",
                "style-plugin-discovery|motion-controller-lifecycle|motion-qualification-500-cycles|accessibility-platform-preference",
            ],
            cwd=ROOT,
            env=environment,
            check=True,
