...
VERSION_FILES = {
    ...
    "plasma/desktoptheme/io.github.loofiboss.noxforge.obsidian.desktop/metadata.json": ((r'(?m)^(\s*"Version":\s*)".*?"(,?)$', r'\g<1>"{version}"\g<2>'),),
    ...
    "look-and-feel/io.github.loofiboss.noxforge.obsidian.desktop/metadata.json": ((r'(?m)^(\s*"Version":\s*)".*?"(,?)$', r'\g<1>"{version}"\g<2>'),),
    "look-and-feel/io.github.loofiboss.noxforge.obsidian.desktop/manifest.json": ((r'(?m)^(\s*"Version":\s*)".*?"(,?)$', r'\g<1>"{version}"\g<2>'),),
    ...
    "wallpapers/NoxForge-Obsidian/metadata.json": ((r'(?m)^(\s*"Version":\s*)".*?"(,?)$', r'\g<1>"{version}"\g<2>'),),
    "wallpapers/NoxForge-Obsidian-Ultrawide/metadata.json": ((r'(?m)^(\s*"Version":\s*)".*?"(,?)$', r'\g<1>"{version}"\g<2>'),),
    ...
    "aurorae/io.github.loofiboss.noxforge.obsidian.desktop/metadata.desktop": ((r"(?m)^X-KDE-PluginInfo-Version=.*$", "X-KDE-PluginInfo-Version={version}"),),
    ...
    "distribution/kde-store/description.md": (
        (r"(?m)^NoxForge .*? is an original", "NoxForge {version} True Obsidian OLED Parity & Dual-Stack Architecture is an original"),
