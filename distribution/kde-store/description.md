...
NoxForge 13.0.2 True Obsidian OLED Parity & Dual-Stack Architecture is an original MIT-licensed Linux
...
Use the exact `noxforge-13.0.2-*.tar.xz` files and verify them against the
release `SHA256SUMS`: https://github.com/loofiboss-bit/NoxForge/releases/tag/v13.0.2
