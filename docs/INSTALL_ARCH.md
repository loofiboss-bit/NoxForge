...
Download the exact 10.0.0 archive and `SHA256SUMS` from the
[GitHub release](https://github.com/loofiboss-bit/NoxForge/releases/tag/v10.0.0).
...
cp noxforge-10.0.0-source.tar.xz "$SRCDEST/"
