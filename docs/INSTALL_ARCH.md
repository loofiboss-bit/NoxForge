...
Download the exact 10.1.0 archive and `SHA256SUMS` from the
[GitHub release](https://github.com/loofiboss-bit/NoxForge/releases/tag/v10.1.0).
...
cp noxforge-10.1.0-source.tar.xz "$SRCDEST/"
