# NoxForge 11.0.0 Deep Focus local qualification

Version: 11.0.0

The complete local v11 release check passed against the exact public 10.1.0
baseline.

| Check | Result |
| --- | --- |
| Python | 128 passed, 9 skipped, 0 failures/errors |
| Fedora Qt 6.11.2 / Plasma and KWin 6.7.4 | 72/72 CTest passed |
| ASan and UBSan | 4/4 probes passed |
| v10.1.0→v11.0.0 staged user/system migration and rollback | Passed; configuration hashes preserved |
...
contrast, the doctor schema 4 contract, Store and portable archives, CMake and
